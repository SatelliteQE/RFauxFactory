...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Generates random data for your tests.}
  spec.description   = %q{Generates random data for your tests. Ruby port for https://github.com/omaciel/fauxfactory.}
